...
[(152条消息) Python中使用哈夫曼算法实现文件的压缩与解压缩_LeafCC的博客-CSDN博客_python哈夫曼树压缩](https://blog.csdn.net/cc815107613/article/details/103260408?ops_request_misc=&request_id=&biz_id=102&utm_term=python哈夫曼编码压缩&utm_medium=distribute.pc_search_result.none-task-blog-2~all~sobaiduweb~default-8-103260408.142^v9^pc_search_result_control_group,157^v4^control&spm=1018.2226.3001.4187)

[python-霍夫曼编码实现压缩和解压缩（二）_来自比邻星的博客-CSDN博客](https://blog.csdn.net/sinat_40936062/article/details/106910216?ops_request_misc=&request_id=&biz_id=102&utm_term=python哈夫曼编码压缩&utm_medium=distribute.pc_search_result.none-task-blog-2~all~sobaiduweb~default-7-106910216.142^v9^pc_search_result_control_group,157^v4^control&spm=1018.2226.3001.4187)